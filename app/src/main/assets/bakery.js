document.addEventListener('DOMContentLoaded', function() {
    console.log('bakery.js: DOMContentLoaded fired');
    function storageAvailable(type) {
        try {
            ...
            console.error('bakery.js: localStorage not available:', e);
            return false;
        }
    }
    ...
    document.querySelectorAll('.add-to-trolley').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (!card || !card.dataset.id) {
                console.error('bakery.js: Invalid product card or missing data-id');
                return;
            }
            ...
            console.log('bakery.js: Adding to trolley:', product);
            let trolley = [];
            try {
                ...
                console.error('bakery.js: Error parsing trolley:', e);
                trolley = [];
            }

            if (!Array.isArray(trolley)) {
                console.error('bakery.js: Trolley is not an array, resetting:', trolley);
                trolley = [];
            }
            ...
            try {
                ...
                console.log('bakery.js: Trolley saved:', trolley);
                alert(`${product.title} added to trolley!`);
            } catch (e) {
                console.error('bakery.js: Error saving to localStorage:', e);
