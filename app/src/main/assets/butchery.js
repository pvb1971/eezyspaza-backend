document.addEventListener('DOMContentLoaded', function() {
    console.log('butchery.js: DOMContentLoaded fired');
    function storageAvailable(type) {
        try {
            ...
            console.error('butchery.js: localStorage not available:', e);
            return false;
        }
    }
    ...
    document.querySelectorAll('.add-to-trolley').forEach(button => {
        button.addEventListener('click', function() {
            ...
            if (!card || !card.dataset.id) {
                console.error('butchery.js: Invalid product card or missing data-id');
                return;
            }
            ...
            console.log('butchery.js: Adding to trolley:', product);
            let trolley = [];
            try {
                ...
                console.error('butchery.js: Error parsing trolley:', e);
                trolley = [];
            }

            if (!Array.isArray(trolley)) {
                console.error('butchery.js: Trolley is not an array, resetting:', trolley);
                trolley = [];
            }
            ...
            try {
                ...
                console.log('butchery.js: Trolley saved:', trolley);
                alert(`${product.title} added to trolley!`);
            } catch (e) {
                console.error('butchery.js: Error saving to localStorage:', e);
